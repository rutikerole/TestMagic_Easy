...
import { ArrowLeftCircleIcon, Calendar1Icon,Files,UserPenIcon,UsersRoundIcon,} from 'lucide-react';
...
function ReportPage({ role }: { role: 'admin' | 'tester' }) {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await fetch(`https://testmagic-backend.onrender.com/testCases`);
